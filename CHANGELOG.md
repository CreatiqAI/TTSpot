...
|---|---|---|---|
| 0.2.6 | 2026-09-15 | _next build_ | Swipe-from-left-edge back now works on every page (root cause: go_router 18 didn't recognise the app's MaterialApp and built no-transition pages; every route now uses an explicit MaterialPage). Pages also slide in from the right again. |
