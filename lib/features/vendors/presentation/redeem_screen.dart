        ...
        builder: (ctx) => AlertDialog(
          content: Column(
            ...
            children: [
              ...
              Text('${r.title}\nBill ${rm(r.bill)} · commission ${rm(r.commission)}', textAlign: TextAlign.center, style: TextStyle(color: AppColors.textSecondary, height: 1.4)),
            ],
          ),
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: _receipt == null ? Icon(AppIcons.receipt, color: AppColors.textSecondary) : null,
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(child: Text('Snap the receipt (optional, helps with the monthly statement).', style: TextStyle(fontSize: 13, color: AppColors.textSecondary))),
                  ],
                ),
                const SizedBox(height: 12),
