        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text(note.date, style: TextStyle(fontSize: 12, color: current ? AppColors.onInk.withValues(alpha: 0.6) : AppColors.textMuted)),
            ],
          ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(child: Text(p, style: TextStyle(fontSize: 13.5, height: 1.4, color: current ? AppColors.onInk.withValues(alpha: 0.9) : AppColors.textSecondary))),
                ],
              ),
            ),
        ],
