...
|---|---|---|---|
| 0.2.3 | 2026-09-15 | _next build_ | Moment albums on the profile (create, edit, delete; kept past 24 h); smoother moment viewer (finger-down pauses at once, next photo preloaded); Create sheet redesigned; Saved tab gains Commented; "story" wording gone. |
