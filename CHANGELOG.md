...
|---|---|---|---|
| 0.3.1 | 2026-09-15 | _next build_ | Waze / Maps / WhatsApp open the app directly (browser fallback); tap "N going" for the full attendee list; TT now: Use my location (nearest places to pick) + Pin on map; visibility gains Everyone (no radius, no ring); clean round red TT pin on the map; Chats: swipe reveals Pin / Delete buttons instead of auto-triggering, empty DMs move to Not chatted yet, starter messages in empty chats. |
