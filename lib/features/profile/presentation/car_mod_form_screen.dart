              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(children: [const Icon(AppIcons.calendarBlank, size: 18, color: AppColors.textSecondary), const SizedBox(width: 8), Text(formatDate(_date), style: const TextStyle(fontSize: 15))]),
                  ),
                ),
              ),
            ],
